...
# =================================================================
# ⚠️ [필수 수정] 여기에 구글 배포에서 복사한 '웹 앱 URL' 주소를 넣어주세요!
...
# Render 구문 에러(SyntaxError)를 방지하기 위해 스타일과 HTML을 모두 한 줄로 결합했습니다.
